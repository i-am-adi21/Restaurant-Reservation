...
public class Custom_Menu_View extends ArrayAdapter<String>{
	
	String[] item_image,item_name,item_quantity,item_price,item_availability;
	
	private Activity context;
	SharedPreferences sh;
	public Custom_Menu_View(Activity context,String[] item_image,String[] item_name,String[] item_quantity,String[] item_price,String[] item_availability){
		
	super(context,R.layout.custom_menu_view,item_image);
